...
class EvalRetrieval:
    ...
    def _choose_random_paragraphs(self, dataset: str, split: str, num_paragraphs: int) -> List[str]:
        pass
    ...
    def _match_paragraphs(self, retrieved_paragraphs: List[str], paragraphs: List[str]) -> List[str]:
        pass

    def _evaluate_retrieval(self, matched_paragraphs: List[str], paragraphs: List[str]) -> float:
        pass
